...
let solved = 0
let startTime
const isLanguageEnglish = html.lang === "en"
...
function ueberpruefeReihenfolge(eingabe) {
    ...
    if (erwarteteReihenfolge.length != sortierteUndDuplizierteBloecke.length) {
        ...
        wrongBox.textContent = isLanguageEnglish ? originalWrongMessageEn : originalWrongMessageDe
    }
